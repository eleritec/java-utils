...
import static net.eleritec.utils.collection.StreamUtil.filter;
import static net.eleritec.utils.collection.StreamUtil.guard;
import static net.eleritec.utils.collection.StreamUtil.list;
import static net.eleritec.utils.collection.StreamUtil.map;
import static net.eleritec.utils.swing.EventTypes.ActionEvents.PERFORMED;
import static net.eleritec.utils.swing.EventTypes.MouseEvents.CLICKED;
import static net.eleritec.utils.swing.EventTypes.MouseEvents.DRAGGED;
import static net.eleritec.utils.swing.EventTypes.MouseEvents.ENTERED;
import static net.eleritec.utils.swing.EventTypes.MouseEvents.EXITED;
import static net.eleritec.utils.swing.EventTypes.MouseEvents.MOVED;
import static net.eleritec.utils.swing.EventTypes.MouseEvents.PRESSED;
import static net.eleritec.utils.swing.EventTypes.MouseEvents.RELEASED;
import static net.eleritec.utils.swing.EventTypes.MouseEvents.WHEEL;
import static net.eleritec.utils.swing.EventTypes.WindowEvents.ACTIVATED;
import static net.eleritec.utils.swing.EventTypes.WindowEvents.CLOSED;
import static net.eleritec.utils.swing.EventTypes.WindowEvents.CLOSING;
import static net.eleritec.utils.swing.EventTypes.WindowEvents.DEACTIVATED;
import static net.eleritec.utils.swing.EventTypes.WindowEvents.DEICONIFIED;
import static net.eleritec.utils.swing.EventTypes.WindowEvents.FOCUS_GAINED;
import static net.eleritec.utils.swing.EventTypes.WindowEvents.FOCUS_LOST;
import static net.eleritec.utils.swing.EventTypes.WindowEvents.ICONIFIED;
import static net.eleritec.utils.swing.EventTypes.WindowEvents.OPENED;
import static net.eleritec.utils.swing.EventTypes.WindowEvents.STATE_CHANGED;
...
import net.eleritec.utils.swing.EventTypes.ActionEvents;
import net.eleritec.utils.swing.EventTypes.ComponentEvents;
import net.eleritec.utils.swing.EventTypes.DocumentEvents;
import net.eleritec.utils.swing.EventTypes.FocusEvents;
import net.eleritec.utils.swing.EventTypes.HierarchyEvents;
import net.eleritec.utils.swing.EventTypes.KeyEvents;
import net.eleritec.utils.swing.EventTypes.MouseEvents;
import net.eleritec.utils.swing.EventTypes.WindowEvents;
...
public class EventListeners {
	...
	public static class ActionListeners extends EventSubscriptionBuilder<EventTypes.ActionEvents, ActionListener, ActionSource> {
		...
		public final ActionListeners onAction(Runnable...handlers) {
			List<Consumer<ActionEvent>> listeners = list(map(h->e->h.run(), handlers));
	...
	public static class DocumentListeners extends EventSubscriptionBuilder<DocumentEvents, DocumentListener, DocumentSource> {
		...
		public DocumentListeners(Object...docSources) {
			super(DocumentEvents.class, list(map(s->toDocumentSource(s), docSources)));
		}
	...
	public static class HierarchyListeners extends EventSubscriptionBuilder<HierarchyEvents, HierarchyListener, Component> {
		...
		public final HierarchyListeners onChange(Runnable...handlers) {
			List<Consumer<HierarchyEvent>> listeners = list(map(h->e->h.run(), handlers));
	...
	public static abstract class EventSubscriptionBuilder<T extends EventTypes, L extends EventListener, S> {
		...
		public final EventSubscriptionBuilder<T, L, S> addSources(Collection<S> sources) {
			this.sources.addAll(list(filter(sources, this::accept)));
			return this;
		}
	...
	public static <I> List<I> getDuckTypes(Class<I> interfaceType, Object...targets) {
		return list(map(t->DuckType.getDuckType(interfaceType, t), targets));
	}
